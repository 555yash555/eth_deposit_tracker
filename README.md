...
The Ethereum Deposit Tracker application monitors and stores Ethereum deposits on the Beacon Deposit Contract. It uses Node.js and MongoDB and is Dockerized to simplify deployment and management. The Docker image is available on Docker Hub.# Ethereum Deposit Tracker(includes docker image)
